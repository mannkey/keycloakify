...
export const EmailUs = (): JSX.Element => (
    <Tooltip content="Send an email to us">
        <a href="mailto:iheal.digital@gmail.com"><Text className="whitespace-nowrap text-blue-600 underline">support@iheal.co.in</Text></a>
    </Tooltip>
)

export const CallUs = (): JSX.Element => (
    <Tooltip content="Reach us via phone">
        <a href="tel:+91-9396584805"><Text className="whitespace-nowrap text-blue-600 underline">+91-9396584805</Text></a>
    </Tooltip>
)
const ServiceAgrement = () => {
    return (
        <div>
            <section>
                <h1 className="text-3xl font-bold mb-4">Terms and Conditions</h1>
                <p className="text-gray-800"><strong>Last Updated:</strong> July 31st, 2024</p>

                <h2 className="text-2xl font-semibold mt-6 mb-4">Agreement to Our Legal Terms</h2>
                <p className="mb-4">
                    We are iHeal Digital ('Company', 'we', 'us', or 'our'). We operate the website <a href="https://iheal.digital" className="text-blue-500 hover:underline">https://iheal.digital</a> (the 'Site') as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').
                </p>
                <p className="mb-4">
                    <span>You can contact us by email at </span>{<EmailUs />} .
                </p>
                <p className="mb-4">
                    These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and iHeal Digital concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                </p>
                <p className="mb-4">
                    We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by [30 days from the date of the email] as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                </p>
                <p className="mb-4">
            ...
            <section>
                ...
                <ul className="list-disc ml-6 mb-4">
                    <li><a href="#our-services" className="text-blue-500 hover:underline">Our Services</a></li>
                    <li><a href="#intellectual-property-rights" className="text-blue-500 hover:underline">Intellectual Property Rights</a></li>
                    <li><a href="#user-representations" className="text-blue-500 hover:underline">User Representations</a></li>
                    <li><a href="#user-registration" className="text-blue-500 hover:underline">User Registration</a></li>
                    <li><a href="#products" className="text-blue-500 hover:underline">Products</a></li>
                    <li><a href="#purchases-and-payment" className="text-blue-500 hover:underline">Purchases and Payment</a></li>
                    <li><a href="#refunds-policy" className="text-blue-500 hover:underline">Refunds Policy</a></li>
                    <li><a href="#prohibited-activities" className="text-blue-500 hover:underline">Prohibited Activities</a></li>
                    <li><a href="#user-generated-contributions" className="text-blue-500 hover:underline">User Generated Contributions</a></li>
                    <li><a href="#contribution-licence" className="text-blue-500 hover:underline">Contribution Licence</a></li>
                    <li><a href="#mobile-application-licence" className="text-blue-500 hover:underline">Mobile Application Licence</a></li>
                    <li><a href="#third-party-websites-and-content" className="text-blue-500 hover:underline">Third-Party Websites and Content</a></li>
                    <li><a href="#advertisers" className="text-blue-500 hover:underline">Advertisers</a></li>
                    <li><a href="#services-management" className="text-blue-500 hover:underline">Services Management</a></li>
                    <li><a href="#term-and-termination" className="text-blue-500 hover:underline">Term and Termination</a></li>
                    <li><a href="#modifications-and-interruptions" className="text-blue-500 hover:underline">Modifications and Interruptions</a></li>
                    <li><a href="#governing-law" className="text-blue-500 hover:underline">Governing Law</a></li>
                    <li><a href="#dispute-resolution" className="text-blue-500 hover:underline">Dispute Resolution</a></li>
                    <li><a href="#corrections" className="text-blue-500 hover:underline">Corrections</a></li>
                    <li><a href="#disclaimer" className="text-blue-500 hover:underline">Disclaimer</a></li>
                    <li><a href="#limitations-of-liability" className="text-blue-500 hover:underline">Limitations of Liability</a></li>
                    <li><a href="#indemnification" className="text-blue-500 hover:underline">Indemnification</a></li>
                    <li><a href="#user-data" className="text-blue-500 hover:underline">User Data</a></li>
                    <li><a href="#electronic-communications-transactions-and-signatures" className="text-blue-500 hover:underline">Electronic Communications, Transactions, and Signatures</a></li>
                    <li><a href="#sms-text-messaging" className="text-blue-500 hover:underline">SMS Text Messaging</a></li>
                    <li><a href="#miscellaneous" className="text-blue-500 hover:underline">Miscellaneous</a></li>
            ...
            <section id="intellectual-property-rights">
                ...
                <p className="mb-4">
                    We are the rightful owner or licensee of all intellectual property rights within our Services, encompassing source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics (collectively referred to as the "Content"), along with the trademarks, service marks, and logos contained therein (the "Marks").
                </p>
                <p className="mb-4">
                    Our Content and Marks are safeguarded by copyright and trademark laws, as well as various other intellectual property rights and unfair competition laws, both in the United States and globally.
                </p>
                <p className="mb-4">
                    The Content and Marks are provided within or through the Services "AS IS" solely for your personal, non-commercial use.
                </p>
            </section>

            <section id="user-representations">
                <h2 className="text-2xl font-semibold mt-6 mb-4">User Representations</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">User Registration</h2>
                <p className="mb-4">
            ...
            <section id="purchases-and-payment">
                <h2 className="text-2xl font-semibold mt-6 mb-4">Purchases and Payment</h2>
                <p className="mb-4">
            ...
            <section id="refunds-policy">
                <h2 className="text-2xl font-semibold mt-6 mb-4">Refunds Policy</h2>
                <p className="mb-4">
            ...
            <section id="user-generated-contributions">
                <h2 className="text-2xl font-semibold mt-6 mb-4">User Generated Contributions</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Contribution License</h2>
                <p className="mb-4">
            ...
            <section id="mobile-application-license">
                <h2 className="text-2xl font-semibold mt-6 mb-4">Mobile Application License</h2>
                <p className="mb-4">
            ...
            <section id="third-party-websites-and-content">
                <h2 className="text-2xl font-semibold mt-6 mb-4">Third-Party Websites and Content</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    If you decide to leave the Site and access the Third-Party Websites or to use or install any Third-Party Content, you do so at your own risk, and you should be aware that these Legal Terms no longer govern. You should review the applicable terms and policies, including privacy and data gathering practices, of any website to which you navigate from the Site or relating to any applications you use or install from the Site. Any purchases you make through Third-Party Websites will be through other websites and from other companies, and we take no responsibility whatsoever in relation to such purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we do not endorse the products or services offered on Third-Party Websites and you shall hold us harmless from any harm caused by your purchase of such products or services. Additionally, you shall hold us harmless from any losses sustained by you or harm caused to you relating to or resulting in any way from any Third-Party Content or any contact with Third-Party Websites.
                </p>
                <h2 className="text-2xl font-semibold mt-6 mb-4">Advertisers</h2>
                <p className="mb-4">
                    We allow advertisers to display advertisements and other information in designated areas of our Services, such as sidebar or banner ads. Advertisers are fully responsible for their advertisements and any related services or products. As an advertiser, you warrant that you have all necessary rights and authority to place advertisements on our Services, including intellectual property, publicity, and contractual rights. We merely provide the advertising space and have no other relationship with advertisers.
                </p>

                <h2 className="text-2xl font-semibold mt-6 mb-4">Services Management</h2>
                <p className="mb-4">
                    ...
                    are excessive in size or are in any way burdensome to our systems; and (5) otherwise manage
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Term and Termination</h2>
                <p className="mb-4">
                    These Legal Terms shall remain in full force and eff ect while you use the Services. WITHOUT
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Modifications and Interruptions</h2>
                <p className="mb-4">
                    ...
                    update any information on our Services. We also reserve the right to modify or discontinue all
                    or part of the Services without notice at any time. We will not be liable to you or any third
                ...
                <p className="mb-4">
                    These Legal Terms and your use of the Services are governed by the laws of the State of [State], without regard to its conflict of law principles.
                </p>
                ...
                <p className="mb-4">
                    ...
                    applicable AAA rules or applicable law, the arbitration will take place in [County, State].
                    ...
                    commenced or prosecuted in the state and federal courts located in [County, State], and
                    the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and
                    forum non convenience with respect to venue and jurisdiction in such state and federal
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Exceptions to Informal Negotiations and Arbitration</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Corrections</h2>
                <p className="mb-4">
                    ...
                    the information on the Services at any time, without prior notice and update information at any time without prior notice.
                </p>
                ...
                <p className="mb-4">
                    ...
                    WEBSITES LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY OR
                ...
                <p className="mb-4">
                    You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affi liates,
                    and all of our respective offi cers, agents, partners, and employees, from and against any loss,
                    ...
                    such claims. We will use reasonable eff orts to notify you of any such claim, action, or
                    proceeding which is subject to this indemnification upon becoming aware of it. damages, liabilities, and expenses arising from your use of the Services, breach of these Terms, violations of third-party rights, or any harmful acts towards other users. We reserve the right to assume exclusive defense of such claims at your expense.
                </p>

                <h2 className="text-2xl font-semibold mt-6 mb-4">User Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">GDPR Compliance (European Union Users)</h2>
                <p className="mb-4">
                    If you are accessing our Services from the European Union (EU), you are entitled to certain protections and rights under the General Data Protection Regulation (GDPR). We are committed to ensuring the privacy and protection of your personal data.
                </p>
                <p className="mb-4">
                    1. Lawful Bases for Processing: We process your personal data under the following lawful bases: (a) your consent, (b) the performance of a contract with you, (c) compliance with our legal obligations, and (d) our legitimate interests which are not overridden by your rights.
                </p>
                <p className="mb-4">
                    2. Data Subject Rights: You have the right to access, correct, delete, restrict or object to the processing of your personal data, and the right to data portability. To exercise these rights, please contact us at [Contact Email].
                </p>
                <p className="mb-4">
                    3. Data Retention: We retain personal data only for as long as necessary to fulfill the purposes we collected it for, including for the purposes of satisfying any legal, accounting, or reporting requirements.
                </p>
                <p className="mb-4">
                    4. Data Protection Officer (DPO): If you have any questions about our data practices or your rights, you may contact our Data Protection Officer at [DPO Contact Email].
                </p>

                <h2 className="text-2xl font-semibold mt-6 mb-4">HIPAA Compliance (U.S. Users)</h2>
                <p className="mb-4">
                    If you are accessing our Services and you are a patient, healthcare provider, or otherwise involved in the healthcare sector within the United States, we are committed to complying with the Health Insurance Portability and Accountability Act of 1996 (HIPAA).
                </p>
                <p className="mb-4">
                    1. Protected Health Information (PHI): We may collect, store, and process your protected health information in accordance with HIPAA guidelines. We implement appropriate administrative, physical, and technical safeguards to protect your PHI.
                </p>
                <p className="mb-4">
                    2. Use and Disclosure of PHI: We will only use or disclose your PHI as permitted by HIPAA, including for treatment, payment, or healthcare operations, or as otherwise required by law.
                </p>
                <p className="mb-4">
                    3. Patient Rights: You have the right to access and obtain a copy of your PHI, request amendments to your PHI, request an accounting of disclosures, and place restrictions on certain uses and disclosures of your PHI. To exercise these rights, please contact us at [Contact Email].
                </p>
                <p className="mb-4">
                    4. Breach Notification: In the event of a breach of unsecured PHI, we will notify affected individuals, the Secretary of the U.S. Department of Health and Human Services, and, in some cases, the media, in accordance with HIPAA requirements.
                </p>
                ...
                <p className="mb-4">
                    iHeal Digital<br />
                    [Company Address]<br />
                    Email: [contact@iheal.digital]<br />
                    Phone: [+91-7207207260]
                </p>
...
export default ServiceAgrement